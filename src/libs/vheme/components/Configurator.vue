<template>
  <div class="space-y-6">
    ...
    >{{ $route.meta.title || $route.name }}</h1>
          ...
          <div class="text-text-100">
            <div class="py-5 gap-10">
              <div v-for="color in schemes" :key="color" class="flex gap-2 items-center uppercase">
                <input type="radio" :value="color" :id="color" v-model="preffered" />
      ...
      <div class="mt-5 md:mt-0 md:col-span-2">
        <div class="p-10 border space-y-10 bg-layer-400 mt-10 rounded-md">
          <div class="flex gap-10">
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-100">100</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-200">200</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-300">300</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-400">400</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-500">500</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-600">600</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-700">700</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-800">800</div>
            <div class="w-16 h-16 rounded-md shadow-md grid place-items-center bg-primary-900">900</div>
          </div>
          <div class="flex h-full">
            ...
            <div class>
              <h1 class="text-text-100">Playground</h1>
              <div class="py-10">
                <input type="range" class="w-full" v-model="hueValue" :min="0" :max="359" :step="1" />
              </div>
...
export default {
  ...
  watch: {
    preffered: {
      immediate: false,
      handler: function (n: string, o: string) {
